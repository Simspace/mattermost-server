...
docker-preview:
	rm -f docker-preview/mattermost-team-linux-amd64.tar.gz
	cp ./dist/mattermost-team-linux-amd64.tar.gz docker-preview/.
	cd ./docker-preview && docker build -t simspace/mattermost-preview:5.11.0 .
